...
namespace UIS\ImageUrls\Block\Product\View;
...
class Gallery extends \Magento\Catalog\Block\Product\View\AbstractView
{
    ...
    protected $_template = 'UIS_ImageUrls::product/view/gallery.phtml';
    ...
    public function __construct(
        \UIS\ImageUrls\Helper\Data $dataHelper,
    ...
    public function isEnabled(){
        $configPath = 'uis_imageurls_config/default/uis_imageurls_enable';
	$isEnabled = false;
	$isEnabled = $this->dataHelper->getValue($configPath, ScopeConfigInterface::SCOPE_TYPE_DEFAULT);

	if ((bool)$isEnabled == false ) { return false; } // Module is disabled
        
	//** Checking 'Show Urls on Product Details Page' attribute **// 
        $product = $this->getProduct();
       
        if ($product) {
           $isEnabled = (bool)$product->getShowImageUrls(); 
        }
